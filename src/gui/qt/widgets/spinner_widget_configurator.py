...
from spinner_widget import QtWaitSpinner

class WaitSpinnerConfigurator(QWidget):
    sb_roundness = None
    sb_opacity = None
    sb_fadepct = None
    sb_lines = None
    ...
    def init_ui(self) -> None:
        ...
        # Window setup
        self.setLayout(grid)
        self.setWindowTitle("QtWaitSpinner Configurator")
        self.setWindowFlags(Qt.WindowType.Dialog)

        # QtWaitSpinner
        self.spinner = QtWaitSpinner(self)
        ...
        self.sb_fadepct = QDoubleSpinBox()
        self.sb_fadepct.setValue(80)
        self.sb_fadepct.setRange(0, 9999)
        ...
        # Connects
        self.sb_roundness.valueChanged.connect(lambda x: setattr(self.spinner, "roundess", x))
        self.sb_opacity.valueChanged.connect(lambda x: setattr(self.spinner, "minimum_trail_opacity", x))
        self.sb_fadepct.valueChanged.connect(lambda x: setattr(self.spinner, "trail_fade_percentage", x))
        self.sb_lines.valueChanged.connect(lambda x: setattr(self.spinner, "number_lines", x))
        ...
        self.sb_inner_radius.valueChanged.connect(lambda x: setattr(self.spinner, "inner_radius", x))
        self.sb_rev_s.valueChanged.connect(lambda x: setattr(self.spinner, "revolutions_per_second", x))
        ...
        groupbox2_layout.addWidget(self.sb_fadepct, *(3, 2))
        ...
        button_hbox.addWidget(self.btn_color)
    ...
    def _randomize(self) -> None:
        ...
        self.sb_fadepct.setValue(random() * 100)
    ...
    def show_init_args(self) -> None:
        ...
        text = (
            ...
            f"lines={self.spinner.number_lines},\n    "
...
if __name__ == "__main__":
    ...
    configurator = WaitSpinnerConfigurator()
    sys.exit(app.exec())